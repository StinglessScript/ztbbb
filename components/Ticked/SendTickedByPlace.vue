...
export default {
  ...
  mounted() {
    // if (this.$route.query.type == "mua") {
    //   this.typeBuy = "One";
    // } else {
    //   this.typeBuy = "Two";
    // }
    // if (this.isPortal && this.isPortal !== "false") {
    //   this.getProduct();
    // }
    // if (Cookies.get("authInfo")) {
    //   user = JSON.parse(Cookies.get("authInfo"));
    //   console.log("🚀 ~ file: SendTicked.vue:102 ~ mounted ~ user:", user);
    //   this.user = user;
    // }
  },
  methods: {
